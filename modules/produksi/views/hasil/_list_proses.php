        ...
        <div class="col-lg-12 col-md-12 col-xs-12 padding-left-0 padding-right-0">
            ...
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <div class="form-group">
                    <input type="text" class="form-control text-right" value="<?=number_format($val->qty_proses) ?>" readonly="true">
                </div>
            </div>

            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <span class="font-size-12">Hasil <?=$val->typeProses().' ('.$val->mesin->name.')' ?>:</span>
            </div>
            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <div class="form-group">
...
<?php else: ?>
    <div class="col-lg-10 col-md-10 col-xs-12 margin-top-20 text-center">

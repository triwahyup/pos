...
/**
 * This is the model class for table "spk_request_item_approval".
 *
 ...
 */
class SpkRequestItemApproval extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'spk_request_item_approval';
    }
    ...
    public function getSpkRequestItem()
    {
        return $this->hasOne(SpkRequestItem::className(), ['no_request' => 'no_request']);
    }

...
class TempSalesOrderItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['qty_order_1', 'qty_order_2', 'qty_order_3', 'harga_beli_1', 'harga_beli_2', 'harga_beli_3', 'harga_jual_1', 'harga_jual_2', 'harga_jual_3', 'total_order'], 'number'],
            [['code'], 'string', 'max' => 12],
    ...
    {
        return $this->hasMany(TempSalesOrderDetail::className(), ['code' => 'code', 'item_code' => 'item_code']);
    }

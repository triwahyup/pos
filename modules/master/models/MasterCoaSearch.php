...
/**
 * MasterCoaSearch represents the model behind the search form of `app\modules\master\models\MasterCoa`.
 */
class MasterCoaSearch extends MasterCoa
{
    /**
     * {@inheritdoc}
     */

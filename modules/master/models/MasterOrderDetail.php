...
class MasterOrderDetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['panjang', 'lebar', 'harga_cetak', 'harga_beli_1', 'harga_beli_2', 'harga_beli_3', 'harga_jual_1', 'harga_jual_2', 'harga_jual_3', 'qty_order_1', 'qty_order_2', 'qty_order_3', 'jumlah_cetak', 'jumlah_objek', 'jumlah_lem', 'total_order'], 'number'],

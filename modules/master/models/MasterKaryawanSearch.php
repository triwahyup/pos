...
/**
 * MasterKaryawanSearch represents the model behind the search form of `app\modules\master\models\MasterPerson`.
 */
class MasterKaryawanSearch extends MasterPerson
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = MasterPerson::find()->where(['type_user'=>3]);

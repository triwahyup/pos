...
/**
 * MasterAccountsSearch represents the model behind the search form of `app\modules\master\models\MasterAccounts`.
 */
class MasterAccountsSearch extends MasterAccounts
{
    /**
     * {@inheritdoc}
     */

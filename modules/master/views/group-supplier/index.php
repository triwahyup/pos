...
$this->title = 'Group Supplier';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="master-group-supplier-index">
    <p class="text-right">
        <?= Html::a('<i class="fontello icon-plus"></i><span>Create Group Supplier</span>', ['create'], ['class' => 'btn btn-success btn-flat btn-sm']) ?>
    </p>

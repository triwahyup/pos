...
<div class="master-kode-akun-form">
...
function init_temp()
{
    $.ajax({
        ...
        complete: function(){
            $("#masterkodeakun-detail_name").val("");
        }
    });
}
...
function get_temp(id)
{
    $.ajax({
        ...
        success: function(data){
            ...
            $("#masterkodeakun-detail_id").val(o.id);
            $("#masterkodeakun-detail_name").val(o.name);
        },
        complete: function(){
            temp.init();
        }
...
{
    $.ajax({
        url: "<?= Url::to(['kode-akun/create-temp']) ?>",
        type: "POST",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
{
    $.ajax({
        url: "<?= Url::to(['kode-akun/update-temp']) ?>",
        type: "POST",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
{
    $.ajax({
        url: "<?= Url::to(['kode-akun/delete-temp']) ?>",
        type: "GET",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
$(document).ready(function(){
    $("body").off("click","[data-button=\"create_temp\"]").on("click","[data-button=\"create_temp\"]", function(e){
        e.preventDefault();
        if($("#masterkodeakun-detail_name").val() != ""){
            if(!$("#masterkodeakun-code").val() && !$("#masterkodeakun-name").val()){
                notification.open("danger", "Kode dan Nama Akun tidak boleh kosong", timeOut);
            }else{
                create_temp($(this));
            }
        }else{
            notification.open("danger", "Detail Akun tidak boleh kosong", timeOut);
        }
    });

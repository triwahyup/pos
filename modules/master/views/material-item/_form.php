...
function um(code)
{
    $.ajax({
        ...
        success: function(data){
            var o = $.parseJSON(data);
            $("[id^=\"tempmastermaterialitempricelist-harga_beli_\"]").attr("readonly", true);
            $("[id^=\"tempmastermaterialitempricelist-harga_jual_\"]").attr("readonly", true);
            
            $("#tempmastermaterialitempricelist-um_1").val(o.um_1);
            $("#tempmastermaterialitempricelist-um_2").val(o.um_2);
            for(var a=1;a<=o.composite;a++){
                $("#tempmastermaterialitempricelist-harga_beli_"+a).attr("readonly", false);
                $("#tempmastermaterialitempricelist-harga_jual_"+a).attr("readonly", false);
            }
            $("#tempmastermaterialitempricelist-name").attr("readonly", false);
        },
        error: function(XMLHttpRequest, textStatus, errorThrown){},
        complete: function(){}
    });
...
{
    $.ajax({
        url: "<?= Url::to(['material-item/get-temp']) ?>",
        type: "GET",
        dataType: "text",
        data: {
            id: id
...
{
    $.ajax({
        url: "<?= Url::to(['material-item/create-temp']) ?>",
        type: "POST",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
{
    $.ajax({
        url: "<?= Url::to(['material-item/update-temp']) ?>",
        type: "POST",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
{
    $.ajax({
        url: "<?= Url::to(['material-item/delete-temp']) ?>",
        type: "GET",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){
...
$(document).ready(function(){
    ...
    $("body").off("click","[data-button=\"create_temp\"]").on("click","[data-button=\"create_temp\"]", function(e){
        ...
        var success = true,
            message = '';
        $.each($("[id^=\"tempmastermaterialitempricelist-\"]"), function(index, element){
...
$(function(){
    <?php if(!$model->isNewRecord): ?>
        init_temp();
        um($("#mastermaterialitem-satuan_code").val());
    <?php endif; ?>
});
</script>
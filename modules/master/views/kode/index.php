...
$this->title = 'Data Kode';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="master-kode-index">
    <?php if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('data-kode[C]')):?>
        <p class="text-right">
            <?= Html::a('<i class="fontello icon-plus"></i><span>Create Data Kode</span>', ['create'], ['class' => 'btn btn-success btn-flat btn-sm']) ?>
        </p>
    <?php endif;?>
            ...
            [
                'buttons' => [
                    'view' => function ($url, $model) {
                        if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('data-kode[R]'))
                    ...
                    'update' => function ($url, $model) {
                        if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('data-kode[U]'))
                    ...
                    'delete' => function ($url, $model) {
                        if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('data-kode[D]'))

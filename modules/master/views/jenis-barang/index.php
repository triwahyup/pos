...
/* @var $searchModel app\modules\master\models\MasterJenisBarangSearch */
...
<div class="master-jenis-barang-index">
    <p class="text-right">
        <?= Html::a('<i class="fontello icon-plus"></i><span>Create Jenis Barang</span>', ['create'], ['class' => 'btn btn-success btn-flat btn-sm']) ?>
    </p>

...
{
    $.ajax({
        url: "<?= Url::to(['invoice-internal/temp']) ?>",
        type: "POST",
        data: $("#form").serialize(),
        dataType: "text",
        ...
        success: function(data){
            ...
            $("#purchaseinternalinvoice-total_invoice").val(o.total_invoice);
        },
        complete: function(){
            setTimeout(function(){
                $("[data-temp]").val("")
...
function get_temp(el)
{
    data = el.data();
    $.ajax({
        url: "<?= Url::to(['invoice-internal/get-temp']) ?>",
        type: "GET",
        dataType: "text",
        data: {
        ...
        success: function(data){
            ...
            if(o.success == true){
                $.each(o.temp, function(index, value){
                    $("#purchaseinternalinvoice-"+index).val(value);
                });
            }else{
...
{
    $.ajax({
        url: "<?= Url::to(['invoice-internal/update-temp']) ?>",
        type: "POST",
        dataType: "text",
        error: function(xhr, status, error) {},
        beforeSend: function(){

...
<div class="purchase-internal-view">
    <p class="text-right">
        ...
        <?php endif; ?>
        <?php if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('purchase-order-asset-dan-not-asset[U]')): ?>
            <?= Html::a('<i class="fontello icon-pencil"></i><span>Update</span>', ['update', 'no_po' => $model->no_po], [
                'class' => 'btn btn-warning btn-flat btn-sm']) ?>
        <?php endif; ?>
        <?php if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('purchase-order-asset-dan-not-asset[D]')): ?>
        ...
        <div class="col-lg-6 col-md-6 col-xs-12 padding-left-0">
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'attribute' => 'type_barang',
                        'value' => function($model, $value) {
                            return (isset($model->typeBarang)) ? $model->typeBarang->name : '';
                        }
                    ],
                ],
            ]) ?>
        ...
        <div class="document-container">
            ...
            <div class="document-body">
                ...
                <?php if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('purchase-order-asset-dan-not-asset[U]')): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <?php if(((new User)->getIsDeveloper()) || \Yii::$app->user->can('purchase-order-asset-dan-not-asset[A]')): ?>
                    <?php if($typeApproval): ?>
                        <div class="text-right">

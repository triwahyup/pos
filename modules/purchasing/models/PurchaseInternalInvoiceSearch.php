...
/**
 * PurchaseInternalInvoiceSearch represents the model behind the search form of `app\modules\purchasing\models\PurchaseInternalInvoice`.
 */
class PurchaseInternalInvoiceSearch extends PurchaseInternalInvoice
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PurchaseInternalInvoice::find()
            ->alias('a')
